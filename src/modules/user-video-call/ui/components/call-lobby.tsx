...
export const UserCallLobby = ({ onJoin }: Props) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full bg-radial from bg-sidebar-accent to-sidebar">
      <div className="py-4 px-8 flex flex-1 items-center justify-center">
        <div className="flex flex-col items-center justify-center gap-y-6 bg-background rounded-lg p-10 shadow-sm">
          <div className="flex flex-col gap-y-2 text-center">
            <h6 className="text-sm">Ready to join</h6>
          ...
          <div className="flex gap-x-2 justify-between w-full">
            <Button asChild variant="ghost">
              <Link href="/user-video-calls">Cancel</Link>
            </Button>
